class FestivalsController < ApplicationController
  ...
  def flickr_images 
    ...
    img_src = "https://api.flickr.com/services/rest/?api_key=#{ENV['FLICKR_KEY']}&method=flickr.photos.search&tags=festival&text=#{festival} #{@festival.location}&sort=relevance&per_page=10&content_type=1&format=json&nojsoncallback=1"
